...
Route::middleware('auth')->post('/doctor/update/{doctor}', 'DoctorsController@update')->name('doctor.update');
...
Route::middleware('auth')->get('/doctor/feedbacks', 'DoctorsController@feedbacks')->name('doctor.feedbacks');
