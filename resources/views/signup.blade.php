		...
		<div class="col s12">
			<ul class="collapsible popout signup" data-collapsible="accordion">
				<li class="" style="border-bottom:10px solid #242b2e">
					<div class="collapsible-header active secondary-color-full"><i class="fa fa-heart background-color-text" aria-hidden="true"></i><p class="no-margin no-padding background-color-text">I am a Patient</p></div>
